...
public class AInformation {
    ...
    private Long id;
    private List<AVariantAnswer> variant_answers;
    private List<AExtendedAnswer> extended_answers;

    public AInformation(Long id, List<AVariantAnswer> variant_answers,
    ...
    public AInformation(List<AVariantAnswer> variant_answers,
                        List<AExtendedAnswer> extended_answers) {
        this.variant_answers = variant_answers;
        this.extended_answers = extended_answers;
    }
